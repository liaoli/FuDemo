...
public class FUManager {
    ...
    private final static String[] ITEM_NAMES = {
            "", "banana.bundle","lixiaolong.bundle", "chibi_reimu.bundle", "mask_liudehua.bundle", "yuguan.bundle", "Mood.bundle", "gradient.bundle"
    };
...
//                    faceunity.fuItemSetParam(faceBeautyItem, "eye_enlarging", 0.5);
                    ...
                    faceunity.fuItemSetParam(faceBeautyItem, "blur_level", 1);
                    faceunity.fuItemSetParam(faceBeautyItem, "color_level", 0.2);
                    faceunity.fuItemSetParam(faceBeautyItem, "red_level", 0.3);
                    faceunity.fuItemSetParam(faceBeautyItem, "face_shape", 0);
                    faceunity.fuItemSetParam(faceBeautyItem, "face_shape_level", 0);
                    faceunity.fuItemSetParam(faceBeautyItem, "cheek_thinning", 0);
                    faceunity.fuItemSetParam(faceBeautyItem, "eye_enlarging", 0);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
