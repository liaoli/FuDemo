...
class EffectAndFilterRecycleViewAdapter extends RecyclerView.Adapter<EffectAndFilterRecycleViewAdapter.ItemViewHolder>{
    ...
    private static final int[] EFFECT_ITEM_RES_ARRAY = {
            R.drawable.ic_delete_all, R.drawable.banana_icon_120x120, R.drawable.lixiaolong, R.drawable.chibi_reimu, R.drawable.liudehua, R.drawable.yuguan, R.drawable.mood, R.drawable.gradient
    };
